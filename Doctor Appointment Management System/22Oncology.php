...
$con=mysqli_connect('localhost','root','') or die(mysqli_error());  
   ...
   $query = "select service_type from employee where service_type='Oncology'";
...
$con=mysqli_connect('localhost','root','') or die(mysqli_error());  
   ...
   $query = "select service_price from services where service_type='Oncology'";
...
<?php 
 ...
 $query = "select employee_name from employee where service_type='Oncology'";
...
session_start();
if (isset($_POST['btn'])) {
 header('location:16Oncologybooking.php');
}
?>
</html>
